...
function generateTemplateContent(moduleName: string) {
  ...
  return [
    ...
    "import { type delete_remove" + TypeName + " } from \"../types/" + moduleName + "/delete_remove" + TypeName + "\";",
    "",
    "// --- Types ---",
    "",
    ...
    "",
    "  get_" + moduleName.slice(0, -1) + "Detail: (id: string): Promise<get_" + moduleName.slice(0, -1) + "Detail> =>",
    ...
    "",
    "  delete_remove" + TypeName + ": (id: string): Promise<delete_remove" + TypeName + "> =>",
